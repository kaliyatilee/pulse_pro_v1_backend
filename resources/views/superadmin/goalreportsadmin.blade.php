            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Goals Report</h4>
                                ...
                                <thead>
                                        ...
                                        @foreach($allActivities as $item)
                                            ...
                                            <td>{{$item->firstname}} {{$item->lastname}} </td>
                                                <td>
                                                    {{\Carbon\Carbon::parse($item->goalDate)->format('d M Y')}}
                                                </td>
                                                <td>{{$item->weight}}</td>
                                                <td>{{$item->steps}}</td>
                                                <td>{{$item->calories}}</td>
...
@endsection@extends('layouts.partner')
@section('content')
<div class="container-fluid">
    <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="card avtivity-card">
                        <div class="card-body">
                            ...
                            <div class="progress" style="height:5px;">
                                <div class="progress-bar bg-danger" style="width: 50%; height:5px;" role="progressbar">
