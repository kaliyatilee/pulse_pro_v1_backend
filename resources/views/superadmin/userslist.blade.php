        ...
        <div class="col-12">
            ...
            <div class="row card-header">
                    ...
                    <div class="col-0 text-right">
                        <a href="{{route('userslistexport')}}" class="button">Export</a>
                    </div>
                </div>
                        ...
                        <table id="example3" class="display min-w850">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a href="{{ route('edituser', ['id' => $partner->id]) }}" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil-square-o"></i></a>
                                            <a href="{{ route('viewusers', ['id' => $partner->id]) }}" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-eye"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach                
    ...
    <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="modal-content"> 
            <div class="modal-header">
                ...
                <a href="{{asset('/public/assets/sampleExcecl/users-import-data.xlsx')}}" class="modal-title" style="padding-right: 25px; cursor: pointer;">Download Sample</a>
            </div>       
            
            <form method="post" action="{{ route('saveusersFromImport') }}" enctype="multipart/form-data">
            @csrf
            <div class="modal-body">
