                                    ...
                                    <nav id="mainnav" class="mainnav">
                                        ...
                                        <ul class="menu">
                                            ...
                                            <li>
                                                ...
                                                <ul class="submenu">
                                                    <li><a href="">Pulse for Corporates</a></li>
                                                    <li><a href="">Pulse for Insurance </a></li>
                                                    <li><a href="">Pulse for Schools</a></li>
                                                </ul><!-- /.submenu -->
                                            </li><!-- /.flat-mega-menu -->
                                            <li><a href="">TECHNOLOGY</a>
                                                <ul class="submenu">
                                                    <li><a href="">ECG</a></li>
                                                    <li><a href="">24/7 Heart Rate</a></li>
                                                    <li><a href="">Sleep Monitoring</a></li>
                                                </ul><!-- /.submenu -->
                                            </li>
                                            <li>
                    ...
                    <div class="col-md-4">
                        <div class="iconbox style_3">
                            ...
                            <div class="box-content">
                                ...
                                <p>
                                    <img src="{{ env('APP_URL') }}assets/landing/img/shop1.jpeg" alt="slider-image" />
                                </p>
                                <p class="box-readmore" >
                                <h2>Ladies Fitness Gear</h2>
                                 <span style="color:#8EC741;">900 PulsePoints</span>
                                </p>
                    ...
                    <div class="col-md-4">
                        <div class="iconbox style_3">
                            ...
                            <div class="box-content">
                                ...
                                <p>
                                    <img src="{{ env('APP_URL') }}assets/landing/img/shop2.jpeg " alt="slider-image" />
                                </p>
                                <p class="box-readmore">
                                <h2>Mens Fitness Gear</h2>
                                <span style="color:#8EC741;">900 PulsePoints</span>
                                </p>
                    ...
                    <div class="col-md-4">
                        <div class="iconbox style_3">
                            ...
                            <div class="box-content">
                                ...
                                <p>
                                    <img src="{{ env('APP_URL') }}assets/landing/img/shop3.jpeg " alt="slider-image" />
                                </p>
                                <p class="box-readmore">
                                <h2>Drinking Water Bottle</h2>
                                <span style="color:#8EC741;">50 PulsePoints</span>
                                </p>
                                <a href="#" class="button lg dark">Shop now <span class="fa fa-arrow-right"></span></a>
                            </div>
                        </div><!-- /.iconbox -->
                    ...
                    <div class="col-md-4">
                        <div class="iconbox style_3">
                            ...
                            <div class="box-content">
                                ...
                                <p>
                                    <img src="{{ env('APP_URL') }}assets/landing/img/shop4.jpeg" alt="slider-image" />
                                </p>
                                <p class="box-readmore">
                                <h2>Nike Lebron</h2>
                                <span style="color:#8EC741;">500 PulsePoints</span>
                                </p>
                                <a href="#" class="button lg dark">Shop now <span class="fa fa-arrow-right"></a>
                            </div>
                        </div><!-- /.iconbox -->
                    ...
                    <div class="col-md-4">
                        <div class="iconbox style_3">
                            ...
                            <div class="box-content">
                                ...
                                <p>
                                    <img src="{{ env('APP_URL') }}assets/landing/img/shop5.jpeg " alt="slider-image" />
                                </p>
                                <p class="box-readmore">
                                <h2>Trojan Trademill</h2>
                                <span style="color:#8EC741;">9000 PulsePoints</span>
                                </p>
                                <a href="#" class="button lg dark">Shop now <span class="fa fa-arrow-right"></span></a>
                            </div>
                        </div><!-- /.iconbox -->
                    ...
                    <div class="col-md-4">
                        <div class="iconbox style_3">
                            ...
                            <div class="box-content">
                                ...
                                <p>
                                    <img src="{{ env('APP_URL') }}assets/landing/img/shop6.jpg " alt="slider-image" />
                                </p>
                                <p class="box-readmore">
                                <h2>Nike Shoes</h2>
                                <span style="color:#8EC741;">200 PulsePoints</span>
                                </p>
                                <a href="#" class="button lg dark">Shop now <span class="fa fa-arrow-right"></span></a>
                            </div>
                        </div><!-- /.iconbox -->
