...
<head>
    ...
    <title>Pulse Health - Admin Dashboard</title>
    <!-- Favicon icon -->
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    <img src="{{ env('APP_URL') }}assets/admin/images/profile/17.jpg" width="20" alt="" />
                                    <div class="header-info">
                                        <span class="text-black"><strong></strong></span>
                                        <p class="fs-14 mb-0">PSMAS</p>
                                        <p class="fs-12 mb-0">Admin</p>
                                    </div>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="{{ env('APP_URL') }}assets/admin/app-profile.html" class="dropdown-item ai-icon">
    ...
    <div class="deznav">
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    <li><a class="ai-icon" href="{{route('dashboard')}}" aria-expanded="true">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                                ...
                                <ul aria-expanded="false">
                                <li><a href="{{route('partnerslist')}}">View Partners</a></li>
                                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Service Providers</a>
                                        <ul aria-expanded="false">
                                            <li><a href="{{route('serviceproviders')}}">Show ServiceProvider</a></li>
                                            <li><a href="{{route('manageservices')}}">Manage ServiceProvider</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">LoyaltyPoints Manager</a>
                                <ul aria-expanded="false">
                                    <li><a href="{{route('pointsgenerated')}}">LoyaltyPoints Generated</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Partner Reports</a>
                                <ul aria-expanded="false">
                                    <li><a href="{{route('subscribedpartnersreports')}}">Subscribed Partners</a></li>
