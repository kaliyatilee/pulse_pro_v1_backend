                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex flex-wrap">
                                            <div class="uploadedimg me-3 mb-2" id="image_preview">
                                                <a target="_blank" href="{{asset('/public/storage/directorid/original')}}/{{$merchant->directorId}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex flex-wrap">
                                            <div class="uploadlogo me-3">
                                                <a target="_blank" href="{{asset('/public/storage/mousigned/original')}}/{{$merchant->mouSigned}}">
