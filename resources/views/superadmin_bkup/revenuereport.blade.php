                ...
                <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="media align-items-center">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <span class="title text-black font-w600"><?= $totalam ?></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card avtivity-card">
                                        <div class="card-body">
                                            <div class="media align-items-center">
                                                ...
                                                <div class="media-body">
                                                    <p class="fs-14 mb-2">Total Licences</p>
                                                    <span class="title text-black font-w600"> <?= $totalcorporatelic + $totalpartnerlic ?></span>
                                                </div>
                                            </div>
                                            <div class="progress" style="height:5px;">
                                                <div class="progress-bar bg-secondary" style="width: 100%; height:5px;"
                                    ...
                                    <div class="card avtivity-card">
                                        <div class="card-body">
                                            <div class="media align-items-center">
                                                ...
                                                <div class="media-body">
                                                    <p class="fs-14 mb-2">Corporaters</p>
                                                    <span class="title text-black font-w600"> <?= $totalcorporatesm ?></span>
                                                </div>
                                            </div>
                                            <div class="progress" style="height:5px;">
                                                <div class="progress-bar bg-secondary" style="width: 100%; height:5px;"
                                    ...
                                    <div class="card avtivity-card">
                                        <div class="card-body">
                                            <div class="media align-items-center">
                                                ...
                                                <div class="media-body">
                                                    <p class="fs-14 mb-2">Corporaters</p>
                                                    <span class="title text-black font-w600"> <?= $totalcorporatelic ?></span>
                                                </div>
                                            </div>
                                            <div class="progress" style="height:5px;">
                                                <div class="progress-bar bg-secondary" style="width: 100%; height:5px;"
                                    ...
                                    <div class="card avtivity-card">
                                        <div class="card-body">
                                            <div class="media align-items-center">
                                                ...
                                                <div class="media-body">
                                                    <p class="fs-14 mb-2">Partners</p>
                                                    <span class="title text-black font-w600"> <?= $totalpartnersm ?></span>
                                                </div>
                                            </div>
                                            <div class="progress" style="height:5px;">
                                                <div class="progress-bar bg-secondary" style="width: 100%; height:5px;"
                                    ...
                                    <div class="card avtivity-card">
                                        <div class="card-body">
                                            <div class="media align-items-center">
                                                ...
                                                <div class="media-body">
                                                    <p class="fs-14 mb-2">Partners</p>
                                                    <span class="title text-black font-w600"> <?= $totalpartnerlic ?></span>
                                                </div>
                                            </div>
                                            <div class="progress" style="height:5px;">
                                                <div class="progress-bar bg-secondary" style="width: 100%; height:5px;"
                    ...
                    {{-- <div class="row mt-3 ml-3">
                        <div class="col-md-6">
                            <div class="form-group">
                                <p><b>Total Revenue:</b> <?= $totalam ?></p>
                                <p>Corporaters: <?= $totalcorporatesm ?></p>
                                <p>Partners: <?= $totalpartnersm ?></p>
                            </div>
                        </div>

                        <div class="col-md-6">
                            <div class="form-group">
                                <p><b>Total Licences:</b> <?= $totalcorporatelic + $totalpartnerlic ?></p>
                                <p>Corporaters: <?= $totalcorporatelic ?></p>
                                <p>Partners: <?= $totalpartnerlic ?></p>
                            </div>
                        </div>
                    </div> --}}
                    ...
                    <div class="card-body">
                                        ...
                                        <div class="card-body">
                                            <div class="media align-items-center">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <span class="title text-black font-w600"><?= $corporates + $partners + $merchants + $users ?></span>
                                                </div>
                                            </div>
                                            <div class="progress" style="height:5px;">
                                                <div class="progress-bar bg-secondary" style="width: 100%; height:5px;"
                                    ...
                                    <div class="card avtivity-card">
                                        <div class="card-body">
                                            <div class="media align-items-center">
                                                ...
                                                <div class="media-body">
                                                    <p class="fs-14 mb-2">Corporaters</p>
                                                    <span class="title text-black font-w600"> <?= $corporates ?></span>
                                                </div>
                                            </div>
                                            <div class="progress" style="height:5px;">
                                                <div class="progress-bar bg-secondary" style="width: 100%; height:5px;"
                                    ...
                                    <div class="card avtivity-card">
                                        <div class="card-body">
                                            <div class="media align-items-center">
                                                ...
                                                <div class="media-body">
                                                    <p class="fs-14 mb-2">Partners</p>
                                                    <span class="title text-black font-w600"> <?= $partners ?></span>
                                                </div>
                                            </div>
                                            <div class="progress" style="height:5px;">
                                                <div class="progress-bar bg-secondary" style="width: 100%; height:5px;"
                                    ...
                                    <div class="card avtivity-card">
                                        <div class="card-body">
                                            <div class="media align-items-center">
                                                ...
                                                <div class="media-body">
                                                    <p class="fs-14 mb-2">Merchant</p>
                                                    <span class="title text-black font-w600"> <?= $merchants ?></span>
                                                </div>
                                            </div>
                                            <div class="progress" style="height:5px;">
                                                <div class="progress-bar bg-secondary" style="width: 100%; height:5px;"
                        ...
                        {{-- <div class="row mt-3 ml-3">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <p><b>Total Users:</b> <?= $corporates + $partners + $merchants + $users ?></p>
                                    <p>Corporaters: <?= $corporates ?></p>
                                    <p>Partners: <?= $partners ?></p>
                                    <p>Merchant: <?= $merchants ?></p>
                                    <p>Users: <?= $users ?></p>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <canvas id="chartLine2" class="chart-dropshadow2"
                                    style="height: 500px !important;"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    $(function() {
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [<?= $onev ?>, <?= $twov ?>, <?= $threev ?>, <?= $fourv ?>,
                        <?= $fivev ?>, <?= $sixv ?>, <?= $sevenv ?>, <?= $eightv ?>
                    ],
                    borderWidth: 3,
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                labels: ['Partner', 'Corporate', 'Merchant', 'Users'],
                datasets: [{
                    label: 'No Of Subscribed Users',
                    data: [<?= $partners ?>, <?= $corporates ?>, <?= $merchants ?>,
                        <?= $users ?>
                    ],
                    borderWidth: 3,
                    backgroundColor: 'transparent',
