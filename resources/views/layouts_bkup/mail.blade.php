...
<meta charset="utf-8">
    ...
    <link href="{{ env('APP_URL') }}assets/admin/vendor/dropzone/dist/dropzone.css" rel="stylesheet">
...
*************-->
        ...
        ***********************************-->
        ...
        <div class="deznav-scroll">
            <ul class="metismenu" id="menu">
                <li><a class="ai-icon" href="javascript:void()" aria-expanded="true">
                ...
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        ...
                        <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Member Reports</a>
                            <ul aria-expanded="false">
                                <li><a href="{{route('membergoals')}}">Goals</a></li>
                                <li><a href="{{route('dailyactivities')}}">Daily Activity</a></li>
                ...
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <span class="nav-text">Goals & Wellness Plans</span>
                    </a>
                    <ul aria-expanded="false">
                ...
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        <li><a href="{{route('memberreports')}} ">Members Reports</a></li>
                        <li><a href="{{route('activityreports')}} ">Activity Reports</a></li>
                        <li><a href="{{route('goalreports')}} ">Target & Goals</a></li>
                        <li><a href="{{route('subscriptions')}}">Subcriptions</a></li>
                        <li><a href="{{route('newsfeedreports')}}">NewsFeed Reports</a></li>
                        <li><a href="">Rewards Reports</a></li>
                    </ul>
                </li>
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        <li><a href="{{route('subscriptions')}} ">Members Subscribed</a></li>
                    </ul>
                </li>
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="http://dexignzone.com/" >AstroTechAfrica</a></p>
            </div>
        </div>
        <!--**********************************
            Footer end
    ...
    ***********************************-->
    ...
    <script src="{{ env('APP_URL') }}assets/admin/vendor/dropzone/dist/dropzone.js"></script>
