...
<div class="container-fluid">
    <div class="row">
                        ...
                        <div class="card-body">
                            <div class="media align-items-center">
                                ...
                                <div class="media-body">
                                    ...
                                    <span class="title text-black font-w600">{{$data['totalmembers']}}</span>
                                </div>
                            </div>
                    ...
                    <div class="card avtivity-card">
                        <div class="card-body">
                            <div class="media align-items-center">
                                ...
                                <div class="media-body">
                                    <p class="fs-14 mb-2">Total Subscribers</p>
                                    <span class="title text-black font-w600">{{$data['totalsubscribers']}}</span>
                                </div>
                            </div>
                            <div class="progress" style="height:5px;">
                ...
                <div class="card">
                    <div class="card-header d-sm-flex d-block pb-3 border-0">
                        <div class="mr-auto pr-3 mb-sm-0 mb-3">
                            <h4 class="text-black fs-20">Wellness Chart</h4>
                            <!--<img src="{{asset('/public/storage/pie1.png')}}">-->
                        </div>
        ...
        <script>
                    ...
                    var xValues = ['Underweight', 'Overweight', 'Normal'];
                    var yValues = [{!! $data['peicount'] !!}];
                    var barColors = [
                    "#b91d47",
                    "#00aba9",
                    "#2b5797",
