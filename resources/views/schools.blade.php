                    ...
                    <ul>
                        ...
                        <li data-transition="random-static" data-slotamount="7" data-masterspeed="1000" data-saveperformance="on">
                            ...
                            <div class="tp-caption sfl title-slide text-left" data-x="50" data-y="203" data-speed="1000" data-start="1000" data-easing="Power3.easeInOut">
                               Get more informed <br> health analytics
                            </div>
                ...
                <div class="item-one-column">
                    <div class="section-progress">
                        <div class="title-section style_1">
                            <div class="desc">
                                <h2>
                                    Let your learners develop healthy behaviors and habits whilst they are young! Pulse for Schools is a unique
                                    package for young learners that includes:
                                </h2>
                                <p>
                                <ol>
                                    <li><span> <b>1.</b> </span> Personalized Wellness Program for your school including Recommended Daily Activity and Intake</li>
                                    <li><span><b>2.</b></span> Pulse Wearables (Pulse Force and Pulse Spirit) to help track activity, monitor heart rate and quality of
                                        sleep to ensure your learners are as productive as they can be scheduled </li>
                                    <li><span><b>3.</b></span> Other Pulse Promotions including discounted medical consults at Pulse-accredited Clinics for your
learners.</li>
                                    <li><span><b>4.</b></span> A Physician-accredited Health and Wellness plan designed specifically for your schools and its needs!</li>
                                </ol>
                                </p>
                            </div>
                        </div>
            ...
            <div id="site-content">
                <div id="page-header">
                    <div class="container">
                        <div class="row">
                            <div class="page-title">
                                <h2 class="title">See how schools are doing it</h2>
                            </div>
                            <div id="page-breadcrumbs">
                                <nav class="breadcrumb-trail breadcrumbs">
                                    <h2 class="trail-browse">Explore from here:</h2>
        ...
        <div class="video-section flat-row parallax parallax4 pad-top60px pad-bottom60px">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <!-- Video Area Start -->
                        <div class="video-area" style="background-image: url(/assets/landing/img/school_sports.jpeg);background-repeat:no-repeat;background-size:cover">
