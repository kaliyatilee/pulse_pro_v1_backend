                                                        ...
                                                        <div class="container">
                                                            <div class="col-md-2">
                                                                ...
                                                                <ul class="mega-menu-sub">
                                                                    <li><a href="{{route('smartwatches')}}">Smartwatches</a></li>
                                                                    <li><a href="{{route('trackers')}}">Trackers</a></li>
    ...
    <div id="site-content">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <!-- Video Area Start -->
                    <div class="video-area" style="background-image: url(/assets/landing/img/pulse3.png);background-repeat:no-repeat;background-size:cover">
