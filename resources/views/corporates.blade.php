                    ...
                    <ul>
                        ...
                        <li data-transition="random-static" data-slotamount="7" data-masterspeed="1000" data-saveperformance="on">
                            ...
                            <div class="tp-caption sfl title-slide text-left" data-x="50" data-y="203" data-speed="1000" data-start="1000" data-easing="Power3.easeInOut">
                                Promoting a healthy <br> workspace
                            </div>
                        </li>
                    </ul>
                </div>
                ...
                <div class="item-one-column">
                    <div class="section-progress">
                        <div class="title-section style_1">
                            <div class="desc">
                                <h2>
                                    Help ensure the health and wellness of your valuable
                                    working staff through Pulse4Corporate, a personalized
                                    wellness program to suit your corporate’s needs.
                                    Pulse for Corporate Packages include
                                </h2>
                        ...
                        <div class="col-md-6">
                            <div class="iconbox style_3">
                                ...
                                <div class="box-content">
                                    ...
                                    <p>
                                        <b>
                                        4. Pulse Wearables (Pulse Force
                                        and Pulse Spirit) to help track
                                        vital body signs as well as
                                        augment daily individual
            ...
            <div id="site-content">
                <div id="page-header">
                    <div class="container">
                        <div class="row">
                            <div class="page-title">
                                <h2 class="title">See how your team can stay healthy</h2>
                            </div>
        ...
        <div class="video-section flat-row parallax parallax4 pad-top60px pad-bottom60px">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <!-- Video Area Start -->
                        <div class="video-area" style="background-image: url(/assets/landing/img/Health-4.png);background-repeat:no-repeat;background-size:cover">
