                    ...
                    <ul>
                        <li data-transition="random-static" data-slotamount="7" data-masterspeed="1000" data-saveperformance="on">
                            ...
                            <div class="tp-caption sfl title-slide text-left" data-x="left" data-y="203" data-speed="1000" data-start="1000" data-easing="Power3.easeInOut">
                               Understand your sleep patterns <br>
                                better
                            </div>
                ...
                <div class="item-two-column section-iconlist">
                    <div class="title-section style_1">
                        <div class="page-title">
                            <h2 class="title" style="font-size: 30pt;font-weight:500"><b>Get to know how PulseHealth keeps you informed on your sleep patterns</b></h2>
                        </div>

                        <div class="desc">
                            <span style="font-size: 18pt;">PulseHealth wearables come embeded with heartrate and motion detectors which monitor your sleep while you catch a nap</span>
                        </div>
                    </div>
    ...
    <div id="site-content">
        <div id="page-header">
            <div class="container">
                <div class="row">
                    <div class="page-title">
                        <h2 class="title">Discover the benefits of <br>
                         sleep-pattern monitoring</h2>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="iconbox style_4">
                            <div class="box-header">
                                ...
                                <h2 class="box-title">Wakeup refreshed
                                </h2>
                            </div>
                            <div class="box-content">
                                <span class="font-size-14px">
                                    <br>
                                    PulseHealth alarms enable you to easily wakeup.
                                </span>
                            </div>
                        </div>
                    </div><!-- /.col-md-3 -->
