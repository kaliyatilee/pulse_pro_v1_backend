                    ...
                    <ul>
                        <li data-transition="random-static" data-slotamount="7" data-masterspeed="1000" data-saveperformance="on">
                            ...
                            <div class="tp-caption sfl title-slide text-left" data-x="left" data-y="203" data-speed="1000" data-start="1000" data-easing="Power3.easeInOut">
                                Discover the power of your heart <br>
                                bit in your hands
                ...
                <div class="item-two-column section-iconlist">
                    <div class="title-section style_1">
                        <div class="page-title">
                            <h2 class="title" style="font-size: 30pt;font-weight:500"><b>Track your heartrate everyday</b></h2>
                        </div>

                        <div class="desc">
                            <span style="font-size: 18pt;">Through the introduction of PulseHealth we have made it possible for anyone to monitor and track their heartrates.
                                This is made possible through the use of sensors such as the ones used in the hospital to give sound readings</span>
                        </div>
                    </div>
    ...
    <div id="site-content">
        <div id="page-header">
            <div class="container">
                <div class="row">
                    <div class="page-title">
                        <h2 class="title">Explore the benefits of heartrate monitoring</h2>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="iconbox style_4">
                            <div class="box-header">
                                ...
                                <h2 class="box-title">Track sleep quality</h2>
                            </div>
                            <div class="box-content">
                                <span class="font-size-14px">Use your heart rate to track sleep stages.</span>
                            </div>
                        </div>
                    </div><!-- /.col-md-3 -->
                    <div class="col-md-4">
                        <div class="iconbox style_4">
                            <div class="box-header">
                                ...
                                <h2 class="box-title">Reach weight goals
                                </h2>
                            </div>
                            <div class="box-content">
                    ...
                    <div class="col-md-4">
                        <div class="iconbox style_4">
                            ...
                            <div class="box-content">
                                <span class="font-size-14px">
                                    Do guided breathing sessions personalised for your heart rate.</span>
                            </div>
                        </div>
                    </div><!-- /.col-md-3 -->
    ...
    <div id="site-content">
        <div id="page-header">
            <div class="container">
                <div class="row">
                    <div class="page-title">
                        <h2 class="title">Discover more possibilities with heartrate monitoring</h2>
                    </div>
                    <div id="page-breadcrumbs">
                        <nav class="breadcrumb-trail breadcrumbs">
                            <h2 class="trail-browse">Explore from here:</h2>
                            ...
                            <div class="col-md-3">
                                <div class="iconbox style_3">
                                    ...
                                    <div class="box-content">
                                        ...
                                        Relax anywhere with personlized breathing sessions 
                            ...
                            <div class="col-md-3">
                                <div class="iconbox style_3">
                                    ...
                                    <div class="box-content">
                                        ...
                                        Get to understand how fit you are without having 
                                        to go for intensive health checks.
                                        <br> <br>
                                        </p>
                            ...
                            <div class="col-md-3">
                                <div class="iconbox style_3">
                                    ...
                                    <div class="box-content">
                                        ...
                                        <p class="box-readmore">
                                        <h2>Monitored resting</h2>
                                        Measure your heartrate when your body is at rest to access
                                        your heart health and see resting heart trends.
                                        </p>
                            ...
                            <div class="col-md-3">
                                <div class="iconbox style_3">
                                    ...
                                    <div class="box-content">
                                        ...
                                        <p class="box-readmore">
                                        <h2>Workout Monitoring </h2>
                                        User real-time heart rates to to understand your fitness requirements 
                                        during workout.
