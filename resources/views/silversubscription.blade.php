                                ...
                                <form id="contactform" class="flat-contact-form" method="post" action="./contact/contact-process.php">
                                    <div class="quick-appoinment">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" autocapitalize="characters" maxlength="15" name="natid" id="natid" value="{{ old('natid') }}" onkeyup="validateId()" required="required" pattern="^[0-9]{2}-[0-9]{6,7}-[A-Z]-[0-9]{2}$" title="ID Format should be in the form of xx-xxxxxxx X xx" placeholder="Enter your National ID...">
