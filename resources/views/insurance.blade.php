                ...
                <div class="tp-banner">
                    <ul>
                        ...
                        <li data-transition="random-static" data-slotamount="7" data-masterspeed="1000" data-saveperformance="on">
                            <img src="{{ env('APP_URL') }}assets/landing/img/insurance.png" alt="slider-image" />
                ...
                <div class="item-one-column">
                    <div class="section-progress">
                        <div class="title-section style_1">
                            <div class="desc">
                                <h2>
                                    Encourage healthy living among your members by partnering with
                                    Pulse! Help your members avoid the economic burden of chronic
                                    illness through a healthy lifestyle and physical wellness.
                                </h2>
                                <p>
                        ...
                        <div class="col-md-4">
                            <div class="iconbox style_3">
                                ...
                                <div class="box-content">
                                    ...
                                    <p>
                                        <b>
                                        1. Individualized Wellness Program for your Corporate and target
                                        wellness goals set and followed up for each employee
                                        </b>
                        ...
                        <div class="col-md-4">
                            <div class="iconbox style_3">
                                ...
                                <div class="box-content">
                                    ...
                                    <p>
                                        <b>
                                        3. Exclusive participation
                                        in Pulse Health expos,
                                        seminars and training
                                        programs <br> for your
                                        Corporate.  
                        ...
                        <div class="col-md-4">
                            <div class="iconbox style_3">
                                ...
                                <div class="box-content">
                                    ...
                                    <p>
                                        <b>
                                        4. Pulse Wearables to help track vital 
                                        body signs as well as augment daily individual training programs for your members 
                                        </br>
                        ...
                        <div class="col-md-4">
                            <div class="iconbox style_3">
                                ...
                                <div class="box-content">
                                    ...
                                    <p>
                                        <b>
                                        5. Discounted medical <br> check-ups for your members at Pulse-accredited Medical Clinics
                                        </b>
                        ...
                        <div class="col-md-4">
                            <div class="iconbox style_3">
                                ...
                                <div class="box-content">
                                    ...
                                    <p>
                                        <b>
                                       6. Back-end access to personalize and incorporate fitness and wellness goals for your members with provisions to run your own wellness program hosted by Pulse!
                                        </b>
            ...
            <div id="site-content">
                <div id="page-header">
                    <div class="container">
                        <div class="row">
                            <div class="page-title">
                                <h2 class="title">Get insured with PulseHealth today</h2>
                            </div>
        ...
        <div class="video-section flat-row parallax parallax4 pad-top60px pad-bottom60px">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <!-- Video Area Start -->
                        <div class="video-area" style="background-image: url(/assets/landing/img/Healthedu.png);background-repeat:no-repeat;background-size:cover">
