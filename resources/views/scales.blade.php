                ...
                <div class="tp-banner">
                    <ul>
                        ...
                        <li data-transition="random-static" data-slotamount="7" data-masterspeed="1000" data-saveperformance="on">
                            <img src="{{ env('APP_URL') }}assets/landing/img/scale1.png" alt="slider-image" />
                            <div class="tp-caption sfl title-slide text-left" data-y="203" data-speed="1000" data-start="1000" data-easing="Power3.easeInOut">
                                <span style="color: #000;">Stay updated on your <br>
                                    health</span>
                            </div>
        ...
        <div class="flat-row pad-top0px pad-bottom20px bg-f4f4f4 ">
            <div class="image-single style_1 clearfix">
                <div class="item-two-column section-iconlist">
                    <div class="title-section style_1">
                        <div class="page-title">
                            <h2 class="title" style="font-size: 30pt;font-weight:500"><b>Pulse Smartscale</b></h2>
                        </div>

                        <div class="desc">
                            <span style="font-size: 18pt;">Get a more complete picture of your health with Pulse Smartscale, an easy-to-use smart scale that displays your weight and syncs it to the PulseHealth app where you can view BMI, track trends over time and more</spa>
                        </div>
                    </div>
                ...
                <div class="item-two-column mag-left flat-single-image-autoheight-style1">
                    ...
                    <img src="assets/landing/img/scale-front.png">
                </div><!-- /.item-two-column -->
            </div><!-- /.image-single -->
        </div><!-- /.flat-row -->
        ...
        <div id="site-content">
            <div id="page-header">
                <div class="container">
                    <div class="row">
                        <div class="page-title">
                            <h2 class="title">Connect to smart scales designed with your goals in mind.</h2>
                        </div>
                            ...
                            <div class="tp-banner-container" >
                                <div class="tp-banner">
                                    <ul>
                                        ...
                                        <li data-transition="random-static" data-slotamount="7" data-masterspeed="1000" data-saveperformance="on">
                                            <img src="{{ env('APP_URL') }}assets/landing/img/features-weight.png" alt="slider-image" />
                                            <div class="tp-caption sfl title-slide text-left" data-x="550" data-y="203" data-speed="1000" data-start="1000" data-easing="Power3.easeInOut">
                                              <span style="font-size: 35pt;color:#000">Discover the PulseSmart <br>
                                               Bluetooth scale </span>
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-sm-push-6 wow fadeIn">
                                ...
                                <div class="row m0 downloads-btns">
                                    ...
                                    <a href="https://play.google.com/store/apps/details?id=com.algebratech.pulse_wellness" class="dload-link"><img src="{{ env('APP_URL') }}assets/landing/img/google-play.png" alt=""></a>
                                </div>
                            </div>
