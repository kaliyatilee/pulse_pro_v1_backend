...
<div class="container-fluid">
                <div class="page-titles">
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="{{route('compose')}}">Email</a></li>
						<li class="breadcrumb-item  active"><a href="{{route('compose')}}">SMS</a></li>
					</ol>
                </div>
                <!-- row -->
                <div class="row">
                                    ...
                                    <div class="compose-content">
                                        <form action="#">
                                            <div class="form-group">
                                                <input type="text" class="form-control bg-transparent" placeholder=" To: Enter phone number(s)">
                                            </div>
                                            <div class="form-group">
