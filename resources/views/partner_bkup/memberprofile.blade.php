                    ...
                    <div class="profile-head">
                        ...
                        <div class="profile-info">
                            <div class="profile-photo">
                                ...
                                <img style="object-fit: cover;border-radius: 50%;margin-top:-10px;"
                                     class="img-fluid" src="{{$memberdata->image}}"
                                     alt="">
                            </div>
                            <div class="profile-details">
                                <div class="profile-name px-3 pt-2">
                                    <div class="profile-email px-2 pt-2">
                                        <h4 class="text-muted mb-0">#{{$memberdata->membership_number}}</h4>

                                    </div>
                                    <div class="profile-email px-2 pt-2">
                                        <h4 class="text-muted mb-0">{{$memberdata->firstname}} {{$memberdata->lastname}}</h4>

                                    </div>

                                    <div class="profile-email px-2 pt-2">
                                        <h4 class="text-muted mb-0">{{$memberdata->email}}</h4>

                                    </div>
{{--                                    <div class="dropdown ml-auto">--}}
{{--                                        <a href="#" class="btn btn-success light sharp" data-toggle="dropdown"--}}
{{--                                           aria-expanded="true">--}}
...
{{--                                            </li>--}}
{{--                                            <li class="dropdown-item"><i--}}
{{--                                                        class="fa fa-user-circle text-primary mr-2"></i> View--}}
{{--                                                Subscription--}}
{{--                                            </li>--}}
...
{{--                                    </div>--}}
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header border-0 pb-0">
                                    <h4 class="text-black fs-14 font-weight-bold mb-0">Wellness Profile</h4>
                                </div>
                                <div class="card-body text-center">
                                    ...
                                    <ul class="d-flex flex-wrap">
                                        ...
                                        {{--                                        </svg>--}}
                                        {{--                                        <span class="fs-12 text-black">Weight</span>--}}
                                        {{--                                    </li>--}}
                                        {{--                                    <li class="mr-5 mb-2">--}}
                                        {{--                                        <svg class="mr-2" width="19" height="19" viewBox="0 0 19 19" fill="none"--}}
                                        {{--                                             xmlns="http://www.w3.org/2000/svg">--}}
                                        ...
                                        {{--                                        </svg>--}}
                                        {{--                                        <span class="fs-12 text-black">Height</span>--}}
                                        {{--                                    </li>--}}
                                        <li class="mr-5 mb-2">
                                            <svg class="mr-2" width="19" height="19" viewBox="0 0 19 19" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                <rect width="19" height="19" rx="9.5" fill="{{$bmiColor}}"/>
                                            </svg>
                                            <span class="fs-12 text-black">{{$bmiStatus}}</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header flex-wrap border-0 pb-0">
                                    ...
                                    <a href="" class="btn btn-success btn-rounded">Set
                                        Target</a>
                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="d-flex align-items-center mb-sm-5 mb-3">
                                                        <div class="d-inline-block relative donut-chart-sale mr-3">
                                                            <span class="donut"
                                                                  data-peity='{ "fill": ["rgb(160, 44, 250)", "rgba(236,236, 236, 1)"],   "innerRadius": 34, "radius":10}'>{{$progress['steps']}}/{{STEPS_TARGET}}</span>
                                                            <small>
                                                        ...
                                                        <div>
                                                            <h4 class="fs-18 text-black">Steps</h4>
                                                            <span>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="d-flex align-items-center mb-sm-5 mb-3">
                                                        <div class="d-inline-block relative donut-chart-sale mr-3">
                                                        <span class="donut"
                                                              data-peity='{ "fill": ["rgb(255, 188, 17)", "rgba(236,236, 236, 1)"], "innerRadius": 34, "radius":10}'>{{$progress['calories']}}/{{CALORIES_TARGET}}</span>
                                                            <small>
                                                                <svg width="24" height="24" viewBox="0 0 24 24"
                                                                     fill="none"
                                                                     xmlns="http://www.w3.org/2000/svg">
                                                                    <g clip-path="url(#clip4)">
                                                                        <path d="M11.9995 5.9999C13.6563 5.9999 14.9994 4.65677 14.9994 2.99995C14.9994 1.34312 13.6563 1.61033e-07 11.9995 1.41496e-07C10.3426 1.21959e-07 8.99953 1.34312 8.99953 2.99995C8.99953 4.65677 10.3426 5.9999 11.9995 5.9999Z"
                                                                              fill="#FFBC11"/>
                                                                        <path d="M17.8302 21.8297L14.1358 23.2153L15.973 23.9042C16.7637 24.1978 17.6168 23.791 17.9044 23.0261C18.0574 22.618 18.0121 22.1905 17.8302 21.8297Z"
                                                                              fill="#FFBC11"/>
                                                                        <path d="M5.0265 16.5949C4.25236 16.3078 3.38663 16.6974 3.09516 17.473C2.80439 18.2486 3.19772 19.1128 3.97327 19.4043L5.59153 20.0111L9.86385 18.4088L5.0265 16.5949Z"
                                                                              fill="#FFBC11"/>
                                                                        <path d="M20.9043 17.473C20.6127 16.6974 19.7471 16.3078 18.9729 16.5949L6.97318 21.0948C6.19754 21.3863 5.80426 22.2505 6.09502 23.0262C6.38251 23.7908 7.23544 24.198 8.02636 23.9043L20.0261 19.4044C20.8018 19.1129 21.1951 18.2487 20.9043 17.473Z"
                                                                              fill="#FFBC11"/>
                                                        ...
                                                        <div>
                                                            <h4 class="fs-18 text-black">Calories </h4>
                                                            <span>{{$progress['calories']}}cal/{{CALORIES_TARGET}}cal</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="d-flex align-items-center mb-sm-0 mb-3">
                                                        <div class="d-inline-block relative donut-chart-sale mr-3">
                                                        <span class="donut"
                                                              data-peity='{ "fill": ["rgb(255, 50, 130)", "rgba(236,236, 236, 1)"], "innerRadius": 34, "radius": 10}'>{{$progress['distance']}}/{{DISTANCE_TARGET}}</span>
                                                            <small>
                                                                <svg width="24" height="24" viewBox="0 0 24 24"
                                                                     fill="none"
                                                                     xmlns="http://www.w3.org/2000/svg">
                                                                    <g clip-path="url(#clip5)">
                                                                        <path d="M10.8586 5.22596L5.87121 10.5542C5.50758 11.0845 5.64394 11.8068 6.17172 12.1679L11.1945 15.6098L11.1945 18.9558C11.1945 19.5921 11.6995 20.125 12.3359 20.1376C12.9874 20.1477 13.5177 19.6249 13.5177 18.976L13.5177 15.0012C13.5177 14.6174 13.3283 14.2588 13.0126 14.0442L9.79041 11.8346L12.5025 8.95833L13.8914 12.1225C14.0758 12.5442 14.4949 12.8169 14.9546 12.8169L19.1844 12.8169C19.8207 12.8169 20.3536 12.3119 20.3662 11.6755C20.3763 11.024 19.8536 10.4937 19.2046 10.4937L15.7172 10.4937C15.2576 9.44821 14.7677 8.41285 14.3409 7.35225C14.1237 6.81689 14.0025 6.58457 13.6036 6.21588C13.5227 6.14013 12.9596 5.62498 12.4571 5.16538C11.995 4.74616 11.2828 4.77394 10.8586 5.22596Z"
                                                                              fill="#FF3282"/>
                                                                        <path d="M15.6162 5.80678C17.0861 5.80678 18.2778 4.61514 18.2778 3.14517C18.2778 1.6752 17.0861 0.483551 15.6162 0.483551C14.1462 0.483551 12.9545 1.6752 12.9545 3.14517C12.9545 4.61514 14.1462 5.80678 15.6162 5.80678Z"
                                                                              fill="#FF3282"/>
                                                                        <path d="M4.89899 23.5164C7.60463 23.5164 9.79798 21.323 9.79798 18.6174C9.79798 15.9117 7.60463 13.7184 4.89899 13.7184C2.19335 13.7184 -1.81927e-07 15.9117 -2.13831e-07 18.6174C-2.45735e-07 21.323 2.19335 23.5164 4.89899 23.5164Z"
                                                                              fill="#FF3282"/>
                                                                        <path d="M19.101 23.5164C21.8066 23.5164 24 21.323 24 18.6174C24 15.9118 21.8066 13.7184 19.101 13.7184C16.3954 13.7184 14.202 15.9118 14.202 18.6174C14.202 21.323 16.3954 23.5164 19.101 23.5164Z"
                                                                              fill="#FF3282"/>
                                                                    </g>
                                                                    <defs>
                                                                        <clipPath id="clip5">
                                                        ...
                                                        <div>
                                                            <h4 class="fs-18 text-black">Distance</h4>
                                                            <span>{{$progress['distance']}}km/{{DISTANCE_TARGET}}km</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="d-flex align-items-center mb-sm-0 mb-3">
                                                        <div class="d-inline-block relative donut-chart-sale mr-3">
                                                        <span class="donut"
                                                              data-peity='{ "fill": ["rgb(130, 190, 101)", "rgba(236,236, 236, 1)"], "innerRadius": 34, "radius":10}'>{{$progress['weeklyGoals']}}/{{WEEKLY_GOALS_TARGET}}</span>
                                                            <small>
                                                                <svg width="24" height="24" viewBox="0 0 24 24"
                                                                     fill="none"
                                                                     xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <div>
                                                            ...
                                                            <span>{{floor($progress['weeklyGoals']/WEEKLY_GOALS_TARGET*100)}}/{{WEEKLY_GOALS_TARGET/WEEKLY_GOALS_TARGET*100}}%</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body pb-0">
                            <div id="memberChartBarRunning"></div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6">
								...
								<span class="p-3 mr-3 rounded bg-danger">
									<svg width="24" height="24" viewBox="0 0 24 24" fill="none"
										...
										<path d="M10.8586 5.22593L5.87121 10.5542C5.50758 11.0845 5.64394 11.8067 6.17172 12.1678L11.1945 15.6098V18.9557C11.1945 19.5921 11.6995 20.1249 12.3359 20.1376C12.9874 20.1476 13.5177 19.6249 13.5177 18.976V15.0012C13.5177 14.6173 13.3283 14.2588 13.0126 14.0441L9.79041 11.8345L12.5025 8.9583L13.8914 12.1224C14.0758 12.5441 14.4949 12.8169 14.9546 12.8169H19.1844C19.8207 12.8169 20.3536 12.3118 20.3662 11.6755C20.3763 11.0239 19.8536 10.4936 19.2046 10.4936H15.7172C15.2576 9.44818 14.7677 8.41282 14.3409 7.35222C14.1237 6.81686 14.0025 6.58454 13.6036 6.21585C13.5227 6.1401 12.9596 5.62495 12.4571 5.16535C11.995 4.74613 11.2828 4.77391 10.8586 5.22593Z"
                                              fill="white"/>
										<path d="M15.6162 5.80675C17.0861 5.80675 18.2778 4.61511 18.2778 3.14514C18.2778 1.67517 17.0861 0.483521 15.6162 0.483521C14.1462 0.483521 12.9545 1.67517 12.9545 3.14514C12.9545 4.61511 14.1462 5.80675 15.6162 5.80675Z"
                                              fill="white"/>
										<path d="M4.89899 23.5163C7.60463 23.5163 9.79798 21.323 9.79798 18.6174C9.79798 15.9117 7.60463 13.7184 4.89899 13.7184C2.19335 13.7184 0 15.9117 0 18.6174C0 21.323 2.19335 23.5163 4.89899 23.5163Z"
                                              fill="white"/>
										<path d="M19.101 23.5163C21.8066 23.5163 24 21.323 24 18.6174C24 15.9117 21.8066 13.7184 19.101 13.7184C16.3954 13.7184 14.202 15.9117 14.202 18.6174C14.202 21.323 16.3954 23.5163 19.101 23.5163Z"
                                              fill="white"/>
									</svg>

								</span>
                            <div class="mr-auto pr-3">
                                <h4 class="text-black fs-20">Walking</h4>

                            </div>
                        </div>
                        <div class="card-body pb-0">
                            <div id="memberChartBarWalking"></div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4">
                    <div class="card">
                        <div class="card-header pb-0 border-0">
								<span class="p-3 mr-3 rounded bg-warning">
									<svg width="24" height="24" viewBox="0 0 24 24" fill="none"
										...
										<path d="M11.9997 5.9999C13.6565 5.9999 14.9997 4.65677 14.9997 2.99995C14.9997 1.34312 13.6565 0 11.9997 0C10.3429 0 8.99977 1.34312 8.99977 2.99995C8.99977 4.65677 10.3429 5.9999 11.9997 5.9999Z"
                                              fill="white"/>
										<path d="M17.8305 21.8297L14.136 23.2153L15.9733 23.9042C16.7639 24.1978 17.6171 23.791 17.9046 23.0261C18.0576 22.618 18.0124 22.1905 17.8305 21.8297Z"
                                              fill="white"/>
										<path d="M5.02674 16.5949C4.2526 16.3078 3.38687 16.6974 3.0954 17.473C2.80464 18.2486 3.19796 19.1128 3.97351 19.4043L5.59177 20.0111L9.86409 18.4088L5.02674 16.5949Z"
                                              fill="white"/>
										<path d="M20.9045 17.473C20.613 16.6974 19.7473 16.3078 18.9732 16.5949L6.97342 21.0948C6.19778 21.3863 5.8045 22.2505 6.09527 23.0262C6.38275 23.7908 7.23569 24.198 8.02661 23.9043L20.0264 19.4044C20.802 19.1129 21.1953 18.2487 20.9045 17.473Z"
                                              fill="white"/>
                        ...
                        <div class="card-body pb-0">
                            <div id="memberChartBarCycling"></div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Activity Listing</h4>
                                </div>
                                <div class="card-body">
    ...
    <script>
        ...
        const dailyTargets = Object.freeze(
            {
                "steps": {!! STEPS_TARGET !!},
