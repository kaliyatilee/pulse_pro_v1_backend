 ...
 */
 ...
 (function (factory) {
    ...
    "use strict";
     ...
     var btnFinish = $("<button class='btn btn-primary btn-submit btn-default float-right disabled' type='button' disabled></button>")
         .text("Register")
         .click(function (){
             $("#registerForm").submit()
         })
          ...
          if (!this.options.cycleSteps) {
              ...
              switch (this._getStepPosition(idx)) {
                  ...
                  case 'last':
                      ...
                      $('.btn-submit').show().removeClass('disabled').removeAttr('disabled');
                      break;
                  default:
